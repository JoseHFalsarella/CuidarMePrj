defmodule CuidarMePrjWeb.UserRegistrationLive do
  use CuidarMePrjWeb, :live_view

  alias CuidarMePrj.Accounts
  alias CuidarMePrj.Accounts.User
  ...
  def render(assigns) do
    ...
    <div class="w-screen h-screen bg-fundo flex items-center font-pop font-semibold">
      ...
      >
        ...
        <:actions>
          <.button phx-disable-with="Creating account..." class="mt-8 m-auto w-[245px] h-[58px] border rounded-3xl bg-botao text-white">Criar conta</.button>
        </:actions>
      </.simple_form>
      </div>
    </div>
