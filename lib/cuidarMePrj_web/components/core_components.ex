defmodule CuidarMePrjWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="bg-zinc-900 fixed inset-0 transition-opacity" aria-hidden="true" />
      <div
        ...
        <div class="flex min-h-full  items-center justify-center">
          <div class=" p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 w-[1100px] h-[360px] relative hidden rounded-2xl bg-white p-6 shadow-lg ring-1 transition"
            >
              <div class="absolute top-6 right-5">
                <button
                  phx-click={JS.exec("data-cancel", to: "##{@id}")}
                  type="button"
                  class="-m-4 flex-none p-5"
                  aria-label={gettext("close")}
                >
                  <.icon name="hero-x-mark" class="h-6 w-6 text-darkBlue"/>
                </button>
              </div>
              <div id={"#{@id}-content"}>
        ...
        <div class="flex min-h-full  items-center justify-center">
          <div class=" p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              phx-key="escape"
              phx-click-away={JS.exec("data-cancel", to: "##{@id}")}
              class="shadow-zinc-700/10 ring-zinc-700/10 w-[1100px] h-auto relative hidden rounded-2xl bg-white p-6 shadow-lg ring-1 transition"
            >
              <div class="absolute top-6 right-5">
                <button
                  phx-click={JS.exec("data-cancel", to: "##{@id}")}
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CuidarMePrjWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CuidarMePrjWeb.Gettext, "errors", msg, opts)
    end
  end
