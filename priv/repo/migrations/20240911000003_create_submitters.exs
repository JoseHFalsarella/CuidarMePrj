defmodule CuidarMePrj.Repo.Migrations.CreateSubmitters do
  use Ecto.Migration

  def change do
    create table(:submitters) do
      add :url, :string
      add :name, :string
      add :email, :string
    ...
    create unique_index(:submitters,[:url])
    create unique_index(:submitters,[:email])
    create unique_index(:submitters,[:phone])
  end
end
